 ...
 */
final class Version20240306135014 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE post_cours (post_id INT NOT NULL, cours_id INT NOT NULL, INDEX IDX_6AD100734B89032C (post_id), INDEX IDX_6AD100737ECF78B0 (cours_id), PRIMARY KEY(post_id, cours_id)) DEFAULT CHARACTER SET utf8mb4');
